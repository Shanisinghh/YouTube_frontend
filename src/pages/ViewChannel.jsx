...
function ViewChannel() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://youtube-backend-2g5b.onrender.com/api/channels/${userData?.user?.channels[0]?._id}`,
        {
  ...
  useEffect(() => {
    axios
      .get("https://youtube-backend-2g5b.onrender.com/api/videos", { withCredentials: true })
      .then((result) => {
  ...
  function handleDelete(videoId) {
    axios
      .delete(`https://youtube-backend-2g5b.onrender.com/api/videos/${videoId}`, {
        withCredentials: true,
      })
      .then((result) => {
        setToggle(!toggle);
