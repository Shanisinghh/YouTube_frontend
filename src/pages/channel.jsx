...
function Chennel() {
  ...
  useEffect(() => {
    axios
      .get("https://youtube-backend-2g5b.onrender.com/api/user", {
  ...
  async function handleChannel(e) {
    ...
    try {
      const response = await axios.post(
        "https://youtube-backend-2g5b.onrender.com/api/channels",
        channelData,
        {
      ...
      await axios.put(
        `https://youtube-backend-2g5b.onrender.com/api/user/${response.data.channel._id}`,
        {},
        {
          headers: { "Content-Type": "application/json" },
          withCredentials: true,
