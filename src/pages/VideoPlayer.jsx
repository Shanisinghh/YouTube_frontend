...
function Video() {
  ...
  useEffect(() => {
    axios
      .get(`https://youtube-backend-2g5b.onrender.com/api/videos/`, {
  ...
  useEffect(() => {
    axios
      .get(`https://youtube-backend-2g5b.onrender.com/api/comments/${videoId}`, {
        withCredentials: true,
      })
      .then((response) => {
  ...
  async function handleComment(e) {
    ...
    try {
      const response = await axios.post(
        "https://youtube-backend-2g5b.onrender.com/api/comments",
  ...
  function handleUpdateComment() {
    ...
    axios
      .put(`https://youtube-backend-2g5b.onrender.com/api/comments/${commentId}`, {
        text: commentInput,
      })
      .then((response) => {
        setTogle(!togle);
  ...
  function handleDelete(commentId) {
    axios
      .delete(`https://youtube-backend-2g5b.onrender.com/api/comments/${commentId}`, {
        withCredentials: true,
      })
      .then((response) => {
        setTogle(!togle);
